                    ...
                    <div class="login-form">
                        <form>
                            <div class="form-group">
                                <div class="input-group"><input class="form-control" type="text" name="name" required="" placeholder="Nama kamu"></div>
                            </div>
                            <div class="form-group">
                                <div class="input-group"><input class="form-control" type="text" name="tanya" required="" placeholder="Apa yang Kamu tanyakan?"></div>
                            </div>
                            <div class="form-group"><button class="btn btn-primary btn-block" type="button" style="color: rgb(255, 255, 255);background: var(--teal);">Ask!</button></div>
                        </form>
                    </div>
                </div>
            </div>

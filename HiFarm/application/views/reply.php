...
<body>
	...
	<div class="box_ask">
		<form action="<?php echo base_url()."index.php/main_page/"; ?>" method="POST">
		<div class= "ask" ><input class="box" type="text" name="jawab" /></div>
		<div><button type="submit" style="color: rgb(255, 255, 255);background: var(--teal);">jawab</button></div>
	</div>

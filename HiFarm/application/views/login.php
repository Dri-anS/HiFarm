...
<body>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean" style="background: var(--teal);">
        <div class="container"><a class="navbar-brand" href="<?= base_url()."index.php/main_page/home"; ?>" style="color: var(--white);">HiFarm</a>
            <ul class="navbar-nav">
            ...
            <div class="col d-flex justify-content-center align-items-center" style="padding: 90px;">
                <div class="login-panel">
                    ...
                    <div class="login-form">
                        <form action="<?php echo base_url()."index.php/main_page/aksi_login"; ?>" method="POST">
                            ...
                            <div class="form-group"><button class="btn btn-primary btn-block" type="submit" style="color: rgb(255, 255, 255);background: var(--teal);">Login</button></div>
                        </form>
                    </div>

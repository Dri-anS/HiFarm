...
<body>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean" style="background: var(--teal);">
        <div class="container"><a class="navbar-brand" href="href="<?= base_url()."index.php/main_page/home";?> style="color: var(--white);">HiFarm</a>
            <ul class="navbar-nav">
    ...
    <div>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 cust_blogteaser" style="padding-bottom:20px;margin-bottom:32px;"><a href="#"><img class="img-fluid" style="height:auto;" src="assets/img/andaliman.jpg"></a>
